...
<main>
    ...
    <li>
      <p>
        ...
        <a
          ...
          target="_blank">https://mrugesh.dev</a
        >
      </p>
    </li>
    <li>
    ...
    <li>
      ...
      <p>
        Their Privacy Policy can be viewed at <a
          ...
          rel="external nofollow noopener"
          target="_blank">https://razorpay.com/privacy/</a
        >
      </p>
    </li>
  </ul>
  ...
  <ul>
    <li>
      <strong>Consent:</strong> You have given Your consent for processing Personal
    ...
    <li>
      <strong>Legitimate interests:</strong> Processing Personal Data is necessary
  ...
  <ul>
    <li>
      ...
      please contact Us to assist You. This also enables You to receive a copy of
      the Personal Data We hold about You.
    </li>
    <li>
      <strong
        >Request correction of the Personal Data that We hold about You.</strong
    ...
    <li>
      <strong>Request the transfer of Your Personal Data.</strong> We will provide
