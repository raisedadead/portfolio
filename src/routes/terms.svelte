...
<main>
  ...
  <ul>
    ...
    <li>
      <p>
        ...
        or "Our" in this Agreement) refers to Mrugesh Mohapatra.
      </p>
    </li>
    <li>
      <p>
    ...
    <li>
      <p>
        <strong>Products</strong> refer to the products or items offered for sale
        on the Service.
      </p>
    </li>
    <li>
      <p>
        <strong>Orders</strong> mean a request by You to purchase Products from Us.
      </p>
    </li>
    <li>
      <p>
        <strong>Promotions</strong> refer to contests, sweepstakes or other promotions
    ...
    <li>
      <p>
        <strong>Terms and Conditions</strong> (also referred as "Terms" or "Terms
        of Use") mean these Terms and Conditions that form the entire agreement between
    ...
    <li>
      <p>
        <strong>Website</strong> refers to Mrugesh Mohapatra's website,
        accessible from
        <a href="https://mrugesh.dev" target="_blank">https://mrugesh.dev</a>
      </p>
    </li>
    <li>
      <p>
  ...
  <p>
    ...
    read our <a href="https://mrugesh.dev/privacy" target="_blank">
      Privacy Policy
    </a> carefully before using Our Service.
  </p>
  ...
  <p>
    If You wish to place an Order for Products available on the Service, You may
    be asked to supply certain information relevant to Your Order including,
    without limitation, Your name, Your email, Your phone number, Your credit
    card number, the expiration date of Your credit card, Your billing address,
  ...
  <p>
    ...
    Products available on Our Service may be mispriced, described inaccurately,
    or unavailable, and We may experience delays in updating information
    regarding our Products on the Service and in Our advertising on other
    websites.
  </p>
  <p>
  ...
  <p>
    ...
    foreign exchange costs and any other matter beyond the control of the
    Company. In that event, You will have the right to cancel Your Order.
  </p>
  <h2>Payments</h2>
  <p>
    Payment can be made through various payment methods we have available, such
    as Visa, MasterCard, Affinity Card, American Express cards or online payment
  ...
  <p>
    ...
    and You are responsible for protecting those rights. You agree that this
    license includes the right for Us to make Your Content available to other
  ...
  <p>
    ...
    to content that You may find offensive, indecent, incorrect or
    ...
    content, or any loss or damage of any kind incurred as a result of your use
    of any content.
  </p>
  ...
  <p>
    ...
    email <span><Email /></span> and include in Your notice a detailed description
  ...
  <p>
    You can contact us via email: <span><Email /></span>. Upon receipt of a
    notification, the Company will take whatever action, in its sole discretion,
    it deems appropriate, including removal of the challenged content from the
    Service.
  </p>
