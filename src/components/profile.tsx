...
export const Profile: React.FC = () => {
  return (
    <div className='flex flex-col items-center justify-center py-10 text-center'>
      <div className='h-24 w-24 overflow-hidden rounded-full border-4 border-orange-300 shadow-lg shadow-black/50 backdrop-blur-lg md:h-32 md:w-32'>
        <Image
          id='profile-image'
      ...
      <div className='mb-4 mt-2 flex flex-col items-center justify-center space-y-2'>
        <Link
          ...
          className='w-80 items-center rounded-md bg-orange-500 px-1 py-1 text-sm font-medium text-slate-100 backdrop-blur-sm hover:bg-orange-300 hover:text-slate-800 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 md:px-4 md:py-2'
        ...
        <div className='flex flex-row justify-between space-x-8'>
          <Link
            ...
            className='w-36 items-center rounded-md bg-orange-200 px-2 py-1 text-sm font-medium text-slate-600 backdrop-blur-sm hover:bg-orange-300 hover:text-slate-800 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 md:px-4 md:py-2'
