...
const anchorClass =
  'inline-flex py-1 px-1 justify-center h-full w-full hover:bg-orange-200 hover:text-slate-800 background-blur-sm items-center no-underline font-mono text-sm font-bold text-slate-600';
