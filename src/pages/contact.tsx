      ...
      <div className='prose prose-sm prose-slate max-w-none'>
        ...
        <div className='flex'>
          <Link
            ...
            className='mx-auto w-[50%] rounded-md border border-solid border-orange-50 bg-orange-500 p-2 text-center font-medium text-black no-underline shadow-[4px_4px_0_0_rgba(60,64,43,.2)] backdrop-blur-sm hover:bg-orange-300 hover:text-slate-800'
