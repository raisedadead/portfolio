      ...
      <section className='mt-10 border-2 border-black bg-white p-5 shadow-[2px_2px_0px_rgba(0,0,0,1)]'>
        <div className='prose prose-sm prose-slate max-w-none'>
          ...
          <p>
            ...
            We invite You to review our policy on cancellation and refunds. The
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Products</strong> refer to the items offered for sale on
                the Service, for example: "a paid consulting session".
              </p>
            </li>
            <li>
              <p>
          ...
          <p>
            ...
            <strong>a reasonable penalty of upto the full Order amount</strong>,
          ...
          <p>
            ...
            Product. Please note it may take longer due to delays in processing
            by your bank or card issuer, after we initiate the refund. Please
            get in touch with your bank or card issuer for more information in
            such cases.
          </p>
          <h2>Contact Us</h2>
          <p>
