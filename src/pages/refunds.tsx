...
const Refunds: NextPage = () => (
  <main className="hover:prose-a:text-gray-900; prose prose-sm prose-gray my-auto mx-auto max-w-4xl p-16 px-4 text-gray-700 prose-a:text-gray-500">
    ...
    <p>
      ...
      <strong>if you have NOT already availed or utilized the product.</strong>
    ...
    <p>
      ...
      acknowledgement of your cancellation request. The refund will be credited
      to the original payment method used to purchase the Product. Please note
      it may take longer due to delays in processing by your bank or card
      issuer, after we initiate the refund. Please get in touch with your bank
      or card issuer for more information in such cases.
    </p>
    <h2>Contact Us</h2>
    <p>
