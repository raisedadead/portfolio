...
const Terms: NextPage = () => (
  <main className="hover:prose-a:text-gray-900; prose-sm prose prose-gray my-auto mx-auto max-w-4xl p-16 px-4 text-gray-700 prose-a:text-gray-500">
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Products</strong> refer to the products or items offered for
          sale on the Service.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          ...
          "Terms of Use") mean these Terms and Conditions that form the entire
