      ...
      <section className='mt-10 border-2 border-black bg-white p-5 shadow-[2px_2px_0px_rgba(0,0,0,1)]'>
        <div className='prose prose-sm prose-slate max-w-none'>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Products</strong> refer to the products or items offered
            ...
            <li>
              <p>
                ...
                or "Terms of Use") mean these Terms and Conditions that form the
