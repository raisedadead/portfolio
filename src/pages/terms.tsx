...
const Terms: NextPage = () => (
  <>
    <MetaHead pageTitle='Terms and Conditions' />
        ...
        <div className={cn('mx-auto max-w-4xl')}>
          ...
          <div className={cn('space-y-6')}>
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Products</strong> refer to the products or items
              ...
              <li>
                <p>
                  ...
                  "Terms" or "Terms of Use") mean these Terms and Conditions
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Mrugesh Mohapatra, Co's
            ...
            <p className='font-medium'>
              Please read our{' '}
              <a
                href='https://mrugesh.dev/privacy'
                target='_blank'
                rel='noreferrer'
              >
                Privacy Policy
            ...
            <p className='font-medium'>
              Please read our{' '}
              <a
                href='https://mrugesh.dev/refunds'
                target='_blank'
                rel='noreferrer'
              >
            ...
            <p>
              We are constantly updating Our offerings of Products on the
              Service. The Products available on Our Service may be mispriced,
              described inaccurately, or unavailable, and We may experience
              delays in updating information regarding our Products on the
