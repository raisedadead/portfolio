...
import type { MockExpandableSectionLabel, MockExpandableSectionProps } from '../__tests__/test-utils';
...
describe('About Page Content', () => {
      ...
      <div>
        <section className='mb-8'>
          <div className='prose prose-lg prose-slate max-w-none'>
            <h1 className='py-4 text-center text-3xl font-extrabold tracking-tight text-slate-900'>About & Contact</h1>
          </div>
        </section>
                ...
                <div data-testid='expandable-section' data-title='About' data-default-open={true}>
                  ...
                  <div>
                    <p className='mb-4 text-lg'>
                      Mrugesh Mohapatra is a software & cloud infrastructure consultant, operating as a sole proprietor
                      of <strong className='font-semibold'> Mrugesh Mohapatra Co. </strong> ("the business") based in
                      Bhubaneswar & Bengaluru, India.
                    </p>
                    <p className='text-lg'>
                      The business is registered with Ministry of Micro Small and Medium Enterprises, Government of
                      India under the "Udyam" scheme.
                    </p>
                  </div>
                </div>
              </li>
              <li>
                <div data-testid='expandable-section' data-title='Business, Billing & Tax' data-default-open={true}>
  ...
  describe('About Section Content', () => {
    it('displays business description', () => {
      ...
      expect(screen.getByText(/Mrugesh Mohapatra is a software & cloud infrastructure consultant/)).toBeInTheDocument();
    ...
    it('mentions Udyam registration', () => {
      ...
      expect(screen.getByText(/registered with Ministry of Micro Small and Medium Enterprises/)).toBeInTheDocument();
  ...
  describe('Business Section Content', () => {
    ...
    it('mentions international tax details', () => {
      ...
      expect(screen.getByText('Tax details for Transactions made outside India:')).toBeInTheDocument();
  ...
  describe('Contact Section Content', () => {
    ...
    it('displays registered office address', () => {
      ...
      expect(screen.getByText(/Mrugesh Mohapatra Co. - 2nd Floor \(Proworks\)/)).toBeInTheDocument();
